...
export default function AnimatedText({ text }) {
    ...
    }, [text]); // Empty dependency array means this useEffect will only run once, similar to `componentDidMount`.
    ...
    return (
         ...
         */
        <Heading fontSize={"xxx-large"} className={animationCompleted ? "animation-completed" : ""}>
